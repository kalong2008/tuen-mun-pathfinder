...
export default function HomePage({ images }: { images: HomepageImages }) {
  return (
    <>
      <VersePopup />
      <motion.div
        ...
        <div className="container mx-auto px-4">
          ...
          >
            <div className="shadow-lg rounded-lg overflow-hidden md:order-2 aspect-[4000/2667]">
              <Image
                src={getPhotoUrl(images.adventurer)}
                alt="幼鋒會活動"
                width={4000}
                height={2667}
                className="w-full h-full object-cover"
        ...
        <div className="container mx-auto px-4">
          ...
          >
            <div className="shadow-lg rounded-lg overflow-hidden md:order-1 aspect-[4000/2667]">
              <Image
                src={getPhotoUrl(images.pathfinder)}
                alt="前鋒會活動"
                width={4000}
                height={2667}
                className="w-full h-full object-cover"
