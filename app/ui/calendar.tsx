            ...
            {uniqueActivitiesForMonth.map((activity) => (
              ...
              >
                ...
                <div className="pl-[24px] text-sm space-y-1">
                  ...
                  {/* Link to notice */}
                  {(activity.title.includes("參觀") || activity.title.includes("步操訓練") || activity.title.includes("日營") || activity.title.includes("行山") || activity.title.includes("露營") || activity.title.includes("遠足") || activity.title.includes("宿營")  || activity.title.includes("暑期") || activity.title.includes("升級禮")) && (
