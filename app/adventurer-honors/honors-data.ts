...
export const adventurerHonors: AdventurerHonor[] = [
  ...
  },
  {
    ...
    answers: [ { requirementIndex: 0, text: "禮貌是指透過良好的舉止和適當的行為來表達對他人的考慮。展示禮貌行為的例子。", source: "Award Book 2020" }, { requirementIndex: 1, text: "黃金法則是耶穌基督在登山寶訓中提出的一條戒律或生活準則，並記錄在馬太福音 7:12。在不同的版本中，它被表述為「己所不欲，勿施於人」。", source: "Award Book 2020" }, { requirementIndex: 2, text: "透過假裝吃飯、餐桌佈置、向孩子們展示正確的餐桌禮儀（例如不要含著食物說話、正確使用叉子和湯匙、說「請」和「謝謝」等）來鼓勵良好的禮儀。您可能希望為幼鋒會舉辦一場「宴會」，以便他們能夠將所學到的知識付諸實踐。", source: "Award Book 2020" }, { requirementIndex: 3, text: "教導幼鋒會在接聽電話時清晰地說話，詢問呼叫者他們想與誰通話，並快速傳達訊息。確保孩子知道在緊急情況下如何尋求幫助。如果沒有電話，請教導幼鋒會如何正確地進行介紹。", source: "Award Book 2020" }, { requirementIndex: 4, text: "給幼鋒會幾分鐘的時間來講述他們的故事。您可能需要分享經驗才能讓他們開始。鼓勵孩子像對待成人一樣善待他人。", source: "Award Book 2020" } ],
    sourceUrls: ["https://youth.hkmcadventist.org/web/clubs/adventurer-2/honor/household/"],
    answerSource: "答案由英文 Award Book 2020 整理/翻譯",
    status: "non-review",
  },
  {
    ...
    answers: [ { requirementIndex: 0, text: "分享時，工作總是更有趣。教導幼鋒會如何幫助父母或兄弟姊妹在家中提供協助。", source: "Award Book 2020" }, { requirementIndex: 1, text: "教導幼鋒會正確擺放桌子：叉子放在盤子的左邊，刀和湯匙放在右邊，杯子或玻璃杯放在刀的右上方，餐巾折疊並放在盤子或叉子的左邊。教他們安全洗碗並自願完成任務。", source: "Award Book 2020" }, { requirementIndex: 2, text: "幼鋒會可能需要鋪床和保持房間清潔的幫助，但他們絕對需要被教導這些重要的責任和良好的習慣。", source: "Award Book 2020" }, { requirementIndex: 3, text: "做家事可能很有趣，並鼓勵孩子參與保持家庭清潔。學會安全地除塵、清掃和吸塵而不造成更多灰塵非常重要。", source: "Award Book 2020" }, { requirementIndex: 4, text: "教導孩子們幫忙清空垃圾桶並將物品放入更大的垃圾箱中。談論如何將垃圾分為玻璃、罐頭和紙張以進行回收。", source: "Award Book 2020" }, { requirementIndex: 5, text: "你可以在幼鋒會時間建立一個「房子」。鼓勵孩子們一起打掃「房子」，並向他們展示如何整齊地完成必要的任務。木製品和窗台需要用乾淨的布擦拭，或者如果是可洗的油漆，則需要用濕布擦拭。將乾淨的抹布或枕頭套放在掃帚上以清除蜘蛛網。使用水或窗戶清潔劑以及乾淨的布或紙巾來清潔窗戶。", source: "Award Book 2020" } ],
    sourceUrls: ["https://youth.hkmcadventist.org/web/clubs/adventurer-2/honor/household/"],
    answerSource: "答案由英文 Award Book 2020 整理/翻譯",
    status: "non-review",
  },
  {
    ...
    aliases: [],
    category: "household",
    requirements: ["1. 找出、閱讀和討論詩篇 119:11、詩篇 51:10 和 詩篇 19:14。", "2. 學習個人衛生原則。", "3. 說出三個重要的洗手時間。", "4. 示範正確的刷牙方法。", "5. 討論保持洗澡的習慣以及如何保持頭髮清潔。", "6. 請說出每一天應該喝多少杯水？", "7. 你認為保持衣服清潔重要嗎？"],
    answers: [ { requirementIndex: 0, text: "討論像耶穌希望我們那樣使用友善和「乾淨」的話語的重要性。找到文本，一起閱讀，並討論每個文本的含義。", source: "Award Book 2020" }, { requirementIndex: 1, text: "讓學習變得有趣；請記住，許多人可能沒有在家中學習基本的清潔知識。玩遊戲、唱歌或製作海報來灌輸基本原則。您可以選擇觀看影片、閱讀書籍或讓健康專家與幼鋒會交談。", source: "Award Book 2020" }, { requirementIndex: 2, text: "教導進食前、上廁所後及處理食物前清潔雙手的重要性。如果可能的話，讓幼鋒會用顯微鏡觀察他們的手。讓他們像平常一樣用肥皂清洗，然後​​將他們的手再次放在顯微鏡下，再次仔細清洗並觀察差異。", source: "Award Book 2020" }, { requirementIndex: 3, text: "刷牙兩分鐘，每天至少兩次。均衡飲食，減少含糖和澱粉類食物的攝入，不要咀嚼冰塊或爆米花仁等堅硬物質。請牙醫或牙醫師示範正確的刷牙方法。 （有時他們會給每個孩子一把牙刷或其他牙齒護理用品）。", source: "Award Book 2020" }, { requirementIndex: 4, text: "乾淨的身體更健康。與孩子分享一些不保持清潔可能出現的問題（蝨子、感冒、感染等）。 玩美容店並展示如何正確洗頭、然後吹乾、梳理頭髮。您可能希望讓美容操作員討論並展示頭髮和手部的良好健康習慣。", source: "Award Book 2020" }, { requirementIndex: 5, text: "我們身體的外部需要水來保持清潔，身體內部也需要水來保持健康。我們每天至少需要喝八杯水。討論上帝如何創造幼鋒會的身體。", source: "Award Book 2020" }, { requirementIndex: 6, text: "保持衣服清潔很重要，這樣我們才能看起來和感覺健康。玩耍或工作後弄髒後，洗澡並穿上乾淨的衣服很重要。", source: "Award Book 2020" }, { requirementIndex: 6, text: "讓幼鋒會與他們的父母或其他成年人一起努力保持他們的房子乾淨整潔。", source: "Award Book 2020" }, { requirementIndex: 6, text: "讓孩子與父母或其他成年人一起洗衣服。", source: "Award Book 2020" } ],
    sourceUrls: ["https://youth.hkmcadventist.org/web/clubs/adventurer-2/honor/household/"],
    answerSource: "答案由英文 Award Book 2020 整理/翻譯",
    status: "non-review",
  },
  {
    ...
    answers: [ { requirementIndex: 0, text: "與父母一起觀看適合年齡的家庭安全影片或電影，並討論您學到的東西。當地警察或消防部門或當地圖書館可能有適合您所在地區的資源。", source: "Award Book 2020" }, { requirementIndex: 1, text: "鼓勵家長幫助幼鋒會製定消防安全計畫。討論滅火器的存放位置以及如何使用它們。人員安全是指拒絕與陌生人搭車等。", source: "Award Book 2020" }, { requirementIndex: 2, text: "為您的學校、俱樂部和/或教會繪製平面圖，並說明在緊急情況下前往何處以及如何離開該區域。在家裡、學校或教會練習這些練習。", source: "Award Book 2020" }, { requirementIndex: 3, text: "當地警察或消防部門或當地圖書館將提供您特定區域的資訊。討論可能出現的災難類型，以便您可以告知孩子並做好準備，而不會嚇到他們。", source: "Award Book 2020" }, { requirementIndex: 4, text: "製作一個「安全偵探」紐帶或絲帶，讓幼鋒會在記錄家裡或學校的潛在問題時佩戴。他們應該尋找危險，例如裝有清潔液或藥物的櫃子上的閂鎖是否破損、電線磨損或電源插頭破損、耙子朝上、人行道上的木板、破損的水龍頭、裝有油漆稀釋劑或汽油的無標籤容器、破碎的玻璃等。", source: "Award Book 2020" }, { requirementIndex: 5, text: "請求允許在公共場所展示海報。", source: "Award Book 2020" }, { requirementIndex: 6, text: "給孩子們安全的環境，讓他們必須回答「是」、「否」或「我會問爸爸媽媽」。從您經歷過的情況開始遊戲，例如地板上的碎玻璃。 Q：「你願意拿起玻璃杯嗎？」 「你會告訴你媽媽嗎？」鼓勵孩子們分享現實情況，並在行動前仔細思考。", source: "Award Book 2020" } ],
    sourceUrls: ["https://youth.hkmcadventist.org/web/clubs/adventurer-2/honor/household/"],
  ...
  },
  {
    ...
    answers: [ { requirementIndex: 0, text: "討論幼鋒會如何成為有愛心的朋友。例如，善待年長的人、你的玩伴或兄弟姊妹。為生病的人送一杯涼水或一束鮮花。分享一本書或一個遊戲。當孩子們描述如何在家裡、教會和學校成為一個有愛心的朋友時，列出清單。學習並討論彼得前書 5:7。", source: "Award Book 2020" }, { requirementIndex: 1, text: "請幼鋒會寫下生日（月份和日期），以便他們可以在新朋友生日時寄送或拿一張卡片或鮮花給他或她一個驚喜。這些問題旨在鼓勵孩子們拜訪他們的新朋友。", source: "Award Book 2020" }, { requirementIndex: 2, text: "鼓勵幼鋒會將一些東西帶到禁閉室並使用要求二中的問題作為對話的基礎來拜訪他們。建議：一個裝有鮮花的籃子、一張孩子畫的並著色的圖畫，或是孩子製作的手工藝品。", source: "Award Book 2020" }, { requirementIndex: 3, text: "與孩子討論他們對神的感受以及如何向他人表達神的愛。", source: "Award Book 2020" }, { requirementIndex: 4, text: "鼓勵孩子們做「甜蜜的驚喜」，或者想辦法讓他們在不被要求做某項任務的情況下成為家裡的幫手。", source: "Award Book 2020" }, { requirementIndex: 5, text: "鼓勵幼鋒會與小組分享他們的經驗。", source: "Award Book 2020" } ],
  ...
  },
  {
    ...
    answers: [ { requirementIndex: 0, text: "規則： A.請勿在沒有成人在場的情況下游泳。 b.不要在水附近奔跑。 c.請勿灌籃他人。 d.請勿推或推他人。 e.在您能夠熟練游泳之前，請勿在頭頂上方的水中玩耍。 f.不依賴漂浮裝置；學習游泳。 g。在不知道水是否安全的情況下，不要跳入水中。", source: "Award Book 2020" }, { requirementIndex: 1, text: "與幼鋒會一起玩一個屏住呼吸、將頭埋入水下的遊戲。您可能會想讓他們先練習在水中屏住呼吸。", source: "Award Book 2020" }, { requirementIndex: 2, text: "在該區域清除岩石、其他游泳者等後，教導幼鋒會安全跳入水中。", source: "Award Book 2020" }, { requirementIndex: 3, text: "玩一個水遊戲，幼鋒會會被潑一些水而不會嚇到他們。", source: "Award Book 2020" }, { requirementIndex: 4, text: "向孩子們展示如何抓住泳池邊緣或槳板，同時練習正確而有力的打腿。", source: "Award Book 2020" }, { requirementIndex: 5, text: "向不會游泳的人展示這些。監督他們的嘗試。切勿讓不會游泳的人獨自嘗試這些。向孩子們展示如何在水下推水、屏住呼吸和踢腿。", source: "Award Book 2020" }, { requirementIndex: 6, text: "向幼鋒會傳授有關何時何地可以安全游泳的安全規則。例如，切勿在沒有成人在場的情況下游泳；暴風雨時不要游泳；在未先檢查該區域之前，切勿跳入或潛入水中；僅在安全且獲得游泳許可的干淨泳池、湖泊和河流中游泳。", source: "Award Book 2020" } ],
    sourceUrls: ["https://youth.hkmcadventist.org/web/clubs/adventurer-2/honor/recreation/"],
    answerSource: "答案由英文 Award Book 2020 整理/翻譯",
    status: "non-review",
  },
  {
    ...
    answers: [ { requirementIndex: 0, text: "如果可能的話，讓幼鋒會在戶外進行這些觀察。如果不可行，可以讓幼鋒會畫出他們找到的物品的圖片，或從舊雜誌上剪下圖片。如果您獲得了記者獎，這些內容可能會被放入幼鋒會的剪貼簿中。", source: "Award Book 2020" }, { requirementIndex: 1, text: "如果可以的話，讓幼鋒會親自觀察人們。如果不可行，可以讓幼鋒會畫出、拍攝或從舊雜誌上剪下穿制服的工人的照片，然後將它們放入記者剪貼簿中或開始製作新的剪貼簿。一些例子是：警察 B.消防員 C.護士 D.郵差E.救護人員 F.交通員", source: "Award Book 2020" }, { requirementIndex: 2, text: "找出、一起閱讀、討論並解釋馬太福音 28:20。", source: "Award Book 2020" }, { requirementIndex: 3, text: "幫助你的幼鋒會學會發現潛在的問題以及他們可以做些什麼來提供幫助，例如，撿垃圾、整理歌本等。", source: "Award Book 2020" }, { requirementIndex: 4, text: "說明幼鋒會可能是優秀的觀察員，但除非他們盡自己的一份力量來清潔自己的區域，否則他們就沒有獲得觀察員獎。", source: "Award Book 2020" }, { requirementIndex: 5, text: "將熟悉的物品放在桌上，讓幼鋒會研究它們。兩分鐘後，蓋住這些物品，讓孩子告訴你或列出他們記住的物品。多玩幾次這個遊戲，可以教導孩子們更善於觀察。", source: "Award Book 2020" } ],
    sourceUrls: ["https://youth.hkmcadventist.org/web/clubs/adventurer-2/honor/recreation/"],
    answerSource: "答案由英文 Award Book 2020 整理/翻譯",
    status: "non-review",
  },
  {
    ...
    answers: [ { requirementIndex: 0, text: "嚮導是幫助你找到道路的人。", source: "Award Book 2020" }, { requirementIndex: 1, text: "不要指望幼鋒會會使用北、南、東、西等方位詞。如果有的話，他們應該給出街道名稱和街區數量。", source: "Award Book 2020" }, { requirementIndex: 2, text: "為了獲得好的指示，幼鋒會必須提出好的問題。孩子們應該從他們認識的人、警察、老師或其他官員那裡得到指示。", source: "Award Book 2020" }, { requirementIndex: 3, text: "幫助幼鋒會規劃交通、邀請、參觀和活動等。旅行結束後，引導大家討論做過的事情和看到的事情。", source: "Award Book 2020" }, { requirementIndex: 4, text: "有些孩子在這個專案上需要幫助。", source: "Award Book 2020" }, { requirementIndex: 5, text: "一起閱讀課文並討論其含義。", source: "Award Book 2020" } ],
    sourceUrls: ["https://youth.hkmcadventist.org/web/clubs/adventurer-2/honor/recreation/"],
    answerSource: "答案由英文 Award Book 2020 整理/翻譯",
    status: "non-review",
  },
  ...
  },
  {
    ...
    answers: [ { requirementIndex: 0, text: "鼓勵幼鋒會完成兩項游泳運動員獎項，以便他們在加入探路者俱樂部時做好繼續初學者游泳的準備。", source: "Award Book 2020" }, { requirementIndex: 1, text: "讓幼鋒會們記住，安全非常重要。確保他們遵守以下規則：禁止跑步、推擠或推擠。 b.在不知道水是安全的、沒有石頭和棍棒等的情況下，不要跳入水中。 c．請勿在暴風雨期間游泳。 d.除非有成人在場，否則請勿游泳。 e.不要依賴漂浮裝置來確保安全。", source: "Award Book 2020" }, { requirementIndex: 2, text: "與幼鋒會單獨合作，這樣每個人都可以毫無恐懼地漂浮。", source: "Award Book 2020" }, { requirementIndex: 3, text: "讓幼鋒會練習面朝下漂浮時屏住呼吸，然後浮出水面呼吸空氣並將臉放回水中繼續漂浮。", source: "Award Book 2020" }, { requirementIndex: 4, text: "將兩塊沒有尖銳邊緣的石頭放在幼鋒會頭頂上方的水中。讓每個孩子跳進去把它們撿起來。", source: "Award Book 2020" }, { requirementIndex: 5, text: "教導正確的踢腿、手臂和手部動作。", source: "Award Book 2020" }, { requirementIndex: 6, text: "教導正確的踢腿、手臂和手部動作。", source: "Award Book 2020" }, { requirementIndex: 7, text: "教導正確的踢腿、手臂和手部動作。", source: "Award Book 2020" }, { requirementIndex: 8, text: "孩子可以做三件事來幫助溺水者： 跑向附近的成年人尋求幫助；伸出一根長棍子供人抓住；向該人扔一根繩子，並將他或她拉到淺水中。", source: "Award Book 2020" } ],
    sourceUrls: ["https://youth.hkmcadventist.org/web/clubs/adventurer-2/honor/recreation/"],
    answerSource: "答案由英文 Award Book 2020 整理/翻譯",
    status: "non-review",
  },
  ...
  },
  {
    ...
    aliases: ["單車II", "單車騎士"],
    category: "recreation",
    requirements: ["1. 獲取道路安全榮譽證。", "2. 示範：", "a. 如何保持單車清潔", "b. 如何安全地騎單車", "c. 騎行時使用轉向提示", "d. 如何保養單車", "3. 參加一次單車活動。", "4. 完成五英里（8 公里）的單車旅程。", "5. 畫一張你的旅程地圖。", "6. 運用這地圖，與家人再次追踪這路線。"],
  ...
  },
  {
    ...
    aliases: [],
    category: "spiritual",
    requirements: ["1. 閱讀出埃及記 20:8-11、以賽亞書 58:13-14 和以賽亞書 66:22-23 並回答以下問題：", "◼ 安息日是一星期中的哪一天？", "◼ 第四條誡命的第一個字是什麼？", "◼ 第四條誡命說明誰創造了萬物？", "◼ 安息日會永遠不復存在嗎？解釋。", "◼ 根據你所閱讀的內容，我們為什麼要期待安息日？", "2. 裝飾一個安息日盒子，並在裡面放置有助於讓你的安尸息日更愉快的物品。一些例子是：", "◼ 聖經故事書•", "◼ 安息日活動清單•", "◼ 用粘土或麵團來述說聖經故事•", "◼ 基督教活動書籍•", "◼ 其他", "3. 完成以下兩個或以上項目，並添加到你的安息日盒子裡：", "◼ 開始製作迷你剪貼簿或相冊，以保存特殊的安息日圖片和回憶。", "◼ 用珠子、寶石或其他裝飾品裝飾一個小燭台，以便在周五晚上用來迎接安息日。", "◼ 製作一個安息日橫額。", "◼ 使用一本安息日講道筆記本，為你參加的至少 2 次講道作記錄並加上圖畫。", "◼ 做一個安息日門柄吊飾，用來提醒安息日。"],
  ...
  },
  {
    ...
    answers: [ { requirementIndex: 0, text: "確保每位孩子有自己的聖經或可使用的兒童聖經；教導如何輕拿、翻閱和標記經文。", source: "Requirement draft" }, { requirementIndex: 1, text: "解釋要尊重聖經：潔淨雙手、輕放、不塗鴉、放在安全乾爽處，並以敬虔態度閱讀。", source: "Requirement draft" }, { requirementIndex: 2, text: "幫助幼鋒會找到《創世記》和《啟示錄》。當孩子講述作者的故事時，鼓勵他們在聖經中找到每本書。玩聖經遊戲、使用毛氈等。讓這成為一次有趣的學習經驗。", source: "Award Book 2020" }, { requirementIndex: 3, text: "讓孩子表演默劇。幼鋒會喜歡表演。鼓勵他們讓故事「生動起來」。準備一盒有助於描繪聖經人物的道具，例如浴袍、圍巾和手杖。", source: "Award Book 2020" }, { requirementIndex: 4, text: "練習找出聖經中的經文。解釋每個部分，以便孩子們能夠理解其含義。一起閱讀。", source: "Award Book 2020" }, { requirementIndex: 5, text: "使用紙盤製作動物或人物面具，說明《但以理與獅子的巢穴》、《創世》和《伊甸園》等故事。表演他們選擇的故事。", source: "Award Book 2020" } ],
    sourceUrls: ["https://youth.hkmcadventist.org/web/clubs/adventurer-2/honor/spiritual/"],
    answerSource: "答案由英文 Award Book 2020 整理/翻譯",
    status: "non-review",
  },
  ...
  },
  {
    ...
    answers: [ { requirementIndex: 0, text: "使用現代版本的聖經，以便幼鋒會能夠理解其語言。", source: "Award Book 2020" }, { requirementIndex: 1, text: "藥物濫用是指濫用任何藥物或藥物。節制意味著生活各方面的自我控制，包括使用有害物質。", source: "Award Book 2020" }, { requirementIndex: 2, text: "邀請醫生或護士參加您的小組會議。如果不可能，請觀看公共衛生辦公室或公共圖書館提供的有關該主題的眾多影片之一。", source: "Award Book 2020" }, { requirementIndex: 3, text: "鼓勵每個幼鋒會參與這次討論。", source: "Award Book 2020" }, { requirementIndex: 4, text: "短劇或戲劇可以在學校或教會相關活動中表演。", source: "Award Book 2020" }, { requirementIndex: 5, text: "提供必要的材料並仔細監督這項活動。", source: "Award Book 2020" }, { requirementIndex: 6, text: "體育雜誌會很有幫助。如果您選擇讓幼鋒會採訪人們，請幫助他們列出問題清單並提前做好必要的預約。", source: "Award Book 2020" } ],
    sourceUrls: ["https://youth.hkmcadventist.org/web/clubs/adventurer-2/honor/spiritual/"],
    answerSource: "答案由英文 Award Book 2020 整理/翻譯",
    status: "non-review",
  },
  {
    ...
    answers: [ { requirementIndex: 0, text: "明智的管家是認真履行自己的職責並照顧好上帝給我們所有人的東西（環境、我們的身體、我們的思想、我們的才能等）的人。", source: "Award Book 2020" }, { requirementIndex: 1, text: "參閱創世記 1、2；詩篇 33:6, 9。", source: "Award Book 2020" }, { requirementIndex: 2, text: "瑪拉基說，我們要將十分之一和奉獻物獻給上帝。當我們在教會奉獻或歸還什一稅時，我們就會這樣做。他一定會祝福那些忠心這樣做的人。", source: "Award Book 2020" }, { requirementIndex: 3, text: "使用雜誌圖片或對我們的安息日學產品可以購買的物品進行繪畫和著色（聖經、安息日學報紙、說明聖經故事的毛氈和圖片、安息日學聚會區等等）。這可能是一項集體活動。將完成的海報放在其他人可以欣賞的地方。", source: "Award Book 2020" }, { requirementIndex: 4, text: "閱讀懷愛倫所寫的《管理忠告》，第 174-176 頁，然後用幼鋒會能夠理解的語言重述寡婦和她的兩個小人物的故事。", source: "Award Book 2020" }, { requirementIndex: 5, text: "明智的管家會特別照顧他或她的財產和財務，以及上帝給他或她的才能。", source: "Award Book 2020" } ],
    sourceUrls: ["https://youth.hkmcadventist.org/web/clubs/adventurer-2/honor/spiritual/"],
    answerSource: "答案由英文 Award Book 2020 整理/翻譯",
    status: "non-review",
  },
  ...
  },
  {
    ...
    aliases: [],
    category: "nature",
    requirements: ["1. 閱讀並討論創世記 1:11-12、創世記 1:29-30 和傳道書 3:2。", "2. 了解馬鈴薯的營養價值。", "3. 馬鈴薯是哪個地方的主要食糧或蔬菜？", "4. 馬鈴薯是怎麼生長的？最理想的生長條件是什麼？", "5. 馬鈴薯有哪些不同的品種？你所在地區有哪些品種？", "6. 馬鈴薯的收成時間及方法。", "7. 完成以下其中一項，並分享你的經驗：", "a. 種植馬鈴薯，觀察它的種植過程", "b. 幫助人採收馬鈴薯。"],
  ...
  },
  {
    ...
    aliases: ["天氣II"],
    category: "nature",
    requirements: ["1. 觀察一天的實際天氣。繪製圖表並將其與天氣預報進行比較。", "2. 描述以下內容：風、雲、霧、雨、陽光和大氣。", "3. 辨別三種預測天氣的儀器。", "4. 了解水的循環及對我們如此重要的原因。", "5. 描述如何測量溫度。", "6. 查找並閱讀有關上帝當日創造空氣（蒼穹）的故事。", "7. 閱讀馬可福音 4：38-39 並講述耶穌做了什麼。", "8. 製作一坐風車。"],
  ...
  },
  {
    ...
    answers: [ { requirementIndex: 0, text: "幫助幼鋒會學習對寵物的責任和適當的照顧。 （您可以購買一隻集體寵物，並讓幼鋒會輪流照顧它。）", source: "Award Book 2020" }, { requirementIndex: 1, text: "教導幼鋒會觀察大自然以及在哪裡獲得識別動物的幫助。 （使用图书馆或博物馆。）", source: "Award Book 2020" }, { requirementIndex: 2, text: "與 2 號相同。", source: "Award Book 2020" }, { requirementIndex: 3, text: "包括家庭成員。談談你所看到的和學到的。", source: "Award Book 2020" }, { requirementIndex: 4, text: "餵食站可以像窗台或地面上的特定位置一樣簡單。為了吸引鳥類和動物，可以使用各種種子、堅果和穀物。", source: "Award Book 2020" }, { requirementIndex: 5, text: "您可以選擇不同的動物遊戲，例如動物樂透、動物骨牌以及復臨安息日會圖書中心或其他基督教書店提供的鳥類和動物遊戲。", source: "Award Book 2020" } ],
    sourceUrls: ["https://youth.hkmcadventist.org/web/clubs/adventurer-2/honor/nature/"],
    answerSource: "答案由英文 Award Book 2020 整理/翻譯",
    status: "non-review",
  },
  {
    ...
    answers: [ { requirementIndex: 0, text: "講述大多數污染物是如何由人類以及他們對上帝創造的生物的漠視造成的。孩子年紀不小了，無法幫忙妥善處理垃圾和人類排泄物。教導您的小組欣賞上帝創造的自然並保護植物、樹木、鳥類和動物。", source: "Award Book 2020" }, { requirementIndex: 1, text: "博物學家可能會幫助您進行識別。將紙放在樹皮上，然後用蠟筆在紙上輕輕擦拭。比較並討論不同的拓片，以及每棵樹如何獨一無二，就像人一樣，並且以自己的方式非常特別。", source: "Award Book 2020" }, { requirementIndex: 2, text: "收集至少四棵不同樹上的葉子。您不妨教孩子如何壓制、乾燥和保存它們。透過放大鏡比較和研究葉子。", source: "Award Book 2020" }, { requirementIndex: 3, text: "您的搜尋可能是在散步時發現的任何自然物品，也可能只是活的生物，如蠕蟲、毛毛蟲、螞蟻或甲蟲。讓幼鋒會有時間描述他們所看到的。", source: "Award Book 2020" }, { requirementIndex: 4, text: "當您參觀動物園、公園或野生動物區等時，尋找較小的、通常不被注意的生物，包括小鳥、動物、植物和花卉。", source: "Award Book 2020" }, { requirementIndex: 5, text: "為了獲得最佳效果，請仔細遵循植物或球莖隨附的說明。", source: "Award Book 2020" } ],
    sourceUrls: ["https://youth.hkmcadventist.org/web/clubs/adventurer-2/honor/nature/"],
    answerSource: "答案由英文 Award Book 2020 整理/翻譯",
    status: "non-review",
  },
  ...
  },
  {
    ...
    aliases: ["圖章樂II"],
    category: "arts-crafts",
    requirements: ["1. 上帝寫了什麼信給我們？", "a. 背誦：出埃及記 32：16", "b. 閱讀出埃及記 34：4，和以斯帖記 3:10", "c. 以上這二個聖經章節，有沒有什麼有關蓋印或刻畫的事呢？", "2. 從聖經當中查尋三個人或幾個人，曾寫信給他們自己的朋友或教會。", "3. 請列出一些我們可以使用橡皮章來完成的作品。", "4. 要使用一個橡皮圖像章來完成作品時，需要什麼材料？", "5. 學習三到五個圖印技巧並示範，例如下列的建議：", "a. 二段式的圖印", "b. 以粉筆劃來修飾", "c. 用馬克筆來修飾", "d. 使用水彩筆", "e. 面具畫像", "6. 說明如何維護橡皮圖章。", "7. 製作三個不同的圖像給你的朋友或家人。"],
  ...
  },
  {
    ...
    answers: [ { requirementIndex: 0, text: "藝術家是自稱並實踐創意藝術的人。與孩子討論他們是什麼類型的藝術家。他們唱歌、演奏樂器、畫畫、表演、做手工等等嗎？從不同的角度來說，我們都是藝術家。", source: "Award Book 2020" }, { requirementIndex: 1, text: "紅、黃、藍是原色。紅色和黃色混合可以得到橙色；混合黃色和藍色變成綠色；混合藍色和紅色得到紫色。", source: "Award Book 2020" }, { requirementIndex: 2, text: "教如何削鉛筆。徹底用力清潔刷。強調處理鉛筆和畫筆的安全。", source: "Award Book 2020" }, { requirementIndex: 3, text: "使用手指顏料或毛氈記號筆時，請穿戴防護罩或舊衣服。鼓勵創造力。", source: "Award Book 2020" }, { requirementIndex: 4, text: "鼓勵創意設計。教導孩子在專案完成後進行清理。工藝書籍或您當地的圖書館將提供有用的資源。", source: "Award Book 2020" }, { requirementIndex: 5, text: "邀請函或海報可以在幼鋒會會議或教會活動等介紹。製作一張卡片、書籤或其他可以作為禮物送給老年人或居家人士（被限制在家中的人）的物品。籃子機", source: "Award Book 2020" } ],
    sourceUrls: ["https://youth.hkmcadventist.org/web/clubs/adventurer-2/honor/artscrafts/"],
    answerSource: "答案由英文 Award Book 2020 整理/翻譯",
    status: "non-review",
  },
  ...
  },
  {
    ...
    answers: [ { requirementIndex: 0, text: "媒體是接觸大量人群的傳播形式，例如報紙和雜誌、電視、電影和錄像、書籍、廣播和音樂錄音。向幼鋒會解釋，任何形式的媒體本身都是中立的，它可以用來做好事，也可以用來做壞事。說明在當今社會，兒童和成人都會受到媒體訊息的轟炸；我們很難避免受到所見、所聞、所讀的影響。這就是為什麼學會透過選擇好的和有幫助的東西來控制媒體很重要。", source: "Award Book 2020" }, { requirementIndex: 1, text: "一起閱讀腓立比書 4:8，並鼓勵幼鋒會將其用作選擇自己所見所聞的指南。與幼鋒會解釋和討論這些原則，並要求他們告訴你他們從這節聖經經文中學到了什麼。", source: "Award Book 2020" }, { requirementIndex: 2, text: "教導幼鋒會注意與耶穌相處的時間與花在世俗活動上的時間相比。幫助每個孩子製作一個圖表來追蹤他或她至少兩週的觀看和閱讀活動。", source: "Award Book 2020" }, { requirementIndex: 3, text: "鼓勵幼鋒會選擇他們認為符合腓立比書 4:8 標準的故事或節目。幫助他們明白，你不能總是透過閱讀評論或廣告來判斷它是否符合耶穌的標準。當您開始閱讀或觀看時，如果不合適，請停止！找點別的東西。鼓勵孩子做出正確的選擇。", source: "Award Book 2020" }, { requirementIndex: 4, text: "早期選擇可以幫助我們意識到我們在這些活動上花了多少時間，並幫助我們更有選擇性。", source: "Award Book 2020" }, { requirementIndex: 5, text: "當幼鋒會完成故事時，強化良好的閱讀和觀看習慣的原則。鼓勵想像力！", source: "Award Book 2020" } ],
    sourceUrls: ["https://youth.hkmcadventist.org/web/clubs/adventurer-2/honor/artscrafts/"],
    answerSource: "答案由英文 Award Book 2020 整理/翻譯",
    status: "non-review",
  },
  {
    ...
    answers: [ { requirementIndex: 0, text: "耶穌會聽這個音樂嗎？音樂榮耀上帝嗎？閱讀《給年輕人的訊息》第 292-296 頁，並與幼鋒會分享您所讀到的概念。", source: "Award Book 2020" }, { requirementIndex: 1, text: "例如鋼琴、小號、單簧管、鈸、長笛、薩克斯風等。鼓勵使用您所在地區常用的樂器。", source: "Award Book 2020" }, { requirementIndex: 2, text: "使用幼鋒會繪製的樂器圖片或從雜誌上剪下的樂器圖片來製作海報或拼貼。", source: "Award Book 2020" }, { requirementIndex: 3, text: "一些例子是：出埃及記 28:33, 34 – 鐘聲 b.列王紀上 10:12 – 豎琴以賽亞書 30:29 - 長笛歷代誌上 15:16 – 鐃鈸以賽亞書 5:12 – 單簧管 f.民數記 10:1-10 – 民角書", source: "Award Book 2020" }, { requirementIndex: 4, text: "練習和演奏簡單的樂器，如豎笛、卡祖笛、口琴等，或鋼琴、小提琴或其他孩子正在學習演奏的樂器。讓這件事變得有趣。對於那些音樂能力較差但可以享受快樂噪音的人來說，可以使用簡單的樂器。創作您自己的樂器。", source: "Award Book 2020" }, { requirementIndex: 5, text: "一起學習兩首新歌並為他人演唱或演奏，或使用節奏樂器或廚房用具一起創作「音樂」。一起演奏並練習為他人演奏。我的繪本", source: "Award Book 2020" } ],
    sourceUrls: ["https://youth.hkmcadventist.org/web/clubs/adventurer-2/honor/artscrafts/"],
    answerSource: "答案由英文 Award Book 2020 整理/翻譯",
    status: "non-review",
  },
