...
const honors: AdventurerHonor[] = [
  {
    ...
    answers: [{ requirementIndex: 0, text: "用字母卡認識 A 至 Z。" }],
...
describe("AdventurerHonorsClient", () => {
  test("renders honor cards in a grid", () => {
    ...
    expect(screen.getByText("2 個榮譽 · 1 待核對 · 1 已核對")).toBeInTheDocument();
  ...
  test("filters honors by search query", () => {
    ...
    expect(screen.getByText("2 個榮譽 · 1 待核對 · 1 已核對 · 目前顯示 1 個")).toBeInTheDocument();
